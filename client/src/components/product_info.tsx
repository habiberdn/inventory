        ...
        <div className="p-6 bg-white flex flex-col rounded-lg gap-4">
            ...
            <div className="flex flex-col gap-2 justify-center p-4 ml-[1rem]">
                <div className="grid w-[70%] items-center gap-1">
                    ...
                    <Input type="text" id="Nama" placeholder="Nama Barang" name="name" onChange={handleChangeInput} required/>
                </div>
                <div className="grid w-[70%] items-center gap-1.5 z-20 h-[4rem]">
                    <label htmlFor="Kategori" className="text-sm">Kategori</label>
                    <Input type="text" id="Kategori" placeholder="Kategori" onClick={handleClick} name="category_name" onChange={handleChangeInput} value={value.category_name} required />
                ...
                <div className="grid w-[70%] items-center gap-1.5">
                    ...
                    <Textarea id="Deskripsi" placeholder="Deskripsi Barang" onChange={handleTextAreaChange} maxLength={100} name="description" required/>
